...
echo "    az account set --subscription 60631e84-1bf3-42ca-bacc-c5242b586725"
...
echo "    cd ~/terraform; terraform apply -auto-approve -var \"prefix=$DBEVAL_PREFIX\" -var \'override_ascluster_map={vm_type=\"Standard_L8s_v2\", vm_count=\"0\", disks_per_vm=\"0\"}\' -var \'override_loadgencluster_map={vm_type=\"Standard_F8s_v2\", vm_count=\"0\"}\' "
